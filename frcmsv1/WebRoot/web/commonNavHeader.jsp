...
<link rel="stylesheet" href="<%=baseUri %>/web/css/main.css" type="text/css" />
...
<table width="982" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2">
  ...
  <tr> 
    <td height="134" background="<%=baseUri %>/web/images/t-bg.jpg"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="87"><img src="<%=baseUri %>/web/images/top-bg.jpg" width="980" height="134"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="50" background="<%=baseUri %>/web/images/navbg.jpg">	 
    	<table cellspacing="0" cellpadding="0" border="0" align="center" width="982">
    		<s:iterator  value="headNavList"  id="headNav" status="st">	
	    		<td align="center" class="text14" <s:if test="#headNav.channel_id == 1">width="100"</s:if>>
	    			<a style="font-size:17px <s:if test=" pid == #headNav.channel_id " > ;color:#3366cc </s:if>" href="<%=baseUri %><s:if test="#headNav.link!=null&&#headNav.link!=''"><s:property value="%{#headNav.link}"/></s:if><s:else><s:property value="%{#headNav.channel_path+getText('?channelId=')+#headNav.channel_id}"/></s:else>">
