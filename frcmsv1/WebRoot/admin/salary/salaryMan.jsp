...
<div region="center" class="easyui-layout">
    <div region="north" style="height:70px;" id="search">
        <div region="center" style="margin-top: 10px;margin-left: 5px;">
            ...
            <label>员工工号：</label><input type="text" name="s_user_code" style="width:100px;">
            <label>员工名称：</label><input type="text" name="s_user_name" style="width:100px;"> 
            <label>部门：</label><input type="text" name="s_org_name" style="width:100px;">             
            </div>
    ...
    <div region="center" title="员工工资列表" style="padding:2px;">
        <table id="salaryList"  rownumbers="true" pagination="true"
               fitColumns="false" nowrap="false" showFooter="true" singleSelect="false" style="height:400px" checkbox="true" autoRowHeight="false" fit="true">
            <thead>
            <tr> 
            	<th checkbox="true"></th>            	
				...
				-->
				<th field="batch_id" width="200px">批次号</th>
            </tr>
            </thead>
        </table>
    </div>
...
<script type="text/javascript" src="js/salaryMan.js"></script>
