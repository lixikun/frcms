...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:base+"/Common/uploadUEIMG.do"             //图片上传提交地址
        ,imagePath: base+""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //附件上传配置区
        ,fileUrl:base+"/Common/uploadUEFile.do"               //附件上传提交地址
        ,filePath: ""                   //附件修正地址，同imagePath
        ,fileFieldName:"uploadFile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
