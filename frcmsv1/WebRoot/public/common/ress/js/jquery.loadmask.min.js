 ...
 */
(function(a) {
	a.fn.mask = function(c, b,is_simple) {
		a(this).each(function() {
					if (b !== undefined && b > 0) {
						var d = a(this);
						d.data("_mask_timeout", setTimeout(function() {
											a.maskElement(d, c,is_simple)
										}, b))
					} else {
						a.maskElement(a(this), c,is_simple)
					}
				})
	};
	...
	a.maskElement = function(d, c,is_simple) {
		...
		if(is_simple)
			e = a('<div class="loadsimplemask"></div>');
